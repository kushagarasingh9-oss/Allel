...
import { z } from 'zod'
import { AGENT_INSTRUCTIONS } from '@/agent/personas/instructions'
import {
  buildRuntimeInstructionBlock,
  buildTurnContextSystemPrompt,
} from '@/agent/runtime/runtime-context'
import {
  getPersona,
  PERSONAS,
  VALID_PERSONA_IDS,
  type PersonaId,
} from '@/agent/personas/personas'
import { isAIConfigured, getLanguageModel } from '@/foundation/ai/ai'
...
import { createApprovalRequest } from '@/agent/memory/approval-store'
import {
  getAccountDetails,
  getAccountMemory,
  getAllAccounts,
  ...
  createIntercomContactTool,
  updateIntercomContactTool,
  tagIntercomContactTool,
  createIntercomNote,
  tagIntercomConvo,
  // Stripe tools
