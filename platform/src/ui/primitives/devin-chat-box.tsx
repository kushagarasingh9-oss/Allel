...
export function DevinChatBox({
  ...
  return (
    <div
      className={cn(
        "w-full max-w-[740px] mx-auto bg-[#1d1d1d] border border-[#282828] rounded-[24px] p-2.5 shadow-[0_6px_28px_rgba(0,0,0,0.4)] flex flex-col gap-2 transition-all select-none",
        className
      )}
    >
      {/* 1. UPPER INNER FLOATING INPUT CARD */}
      <div className="w-full bg-[#282828] border border-[#343434] rounded-[20px] p-3.5 sm:p-4 focus-within:border-zinc-500 transition-all flex flex-col justify-between min-h-[96px]">
        {/* Textarea Input */}
        <textarea
          ref={textareaRef}
          value={value}
      ...
      <div className="flex items-center justify-between px-3.5 py-1 text-xs">
