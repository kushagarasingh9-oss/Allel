    ...
    <div
      className={cn(
        ...
        hideStatusBanner
          ...
          : "bg-[#121214] border border-white/[0.08] rounded-[24px] p-1.5 shadow-[0_16px_40px_rgba(0,0,0,0.6)] flex flex-col gap-1.5",
        className
      )}
    >
      {/* 1. UPPER INNER FLOATING INPUT CARD */}
      <div className="w-full bg-[#161618] border border-white/[0.08] rounded-[18px] p-3.5 sm:p-4 focus-within:border-white/25 transition-all flex flex-col justify-between min-h-[102px] relative shadow-md">
