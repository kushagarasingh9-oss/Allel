...
export function DevinChatBox({
  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-[#282828] border border-[#333333] rounded-[16px] p-3.5 focus-within:border-zinc-500 transition-all flex flex-col justify-between min-h-[90px]">
        {/* Textarea Input */}
        <textarea
          ref={textareaRef}
          value={value}
