  ...
  if (message.role === "user") {
    ...
    return (
      <div className="w-full flex justify-end items-center my-3 relative z-10">
        <div className="bg-[#1e1e1e] border border-[#282828] text-zinc-200 text-xs sm:text-sm font-normal px-4.5 py-3 rounded-[20px] rounded-tr-[5px] max-w-[85%] sm:max-w-[70%] shadow-sm leading-relaxed break-words">
          {textContent}
        </div>
      </div>
    )
