...
const TOOL_ICONS: Record<string, React.ReactNode> = {
  ...
  getRecoveryCaseTimeline: <img src="/logos/stripe.svg" alt="Stripe" className="w-4 h-4 object-contain shrink-0" />,
  ...
  getStripeCustomerDetail: <img src="/logos/stripe.svg" alt="Stripe" className="w-4 h-4 object-contain shrink-0" />,
  getStripeSubscriptionDetail: <img src="/logos/stripe.svg" alt="Stripe" className="w-4 h-4 object-contain shrink-0" />,
  getUpcomingStripeInvoice: <img src="/logos/stripe.svg" alt="Stripe" className="w-4 h-4 object-contain shrink-0" />,
...
const TOOL_LABELS: Record<string, string> = {
  ...
  getStripeCustomerDetail: "Reading Stripe customer profile",
  getStripeSubscriptionDetail: "Reading Stripe subscription details",
  getUpcomingStripeInvoice: "Checking upcoming Stripe invoice",
  ...
  getRecoveryCaseTimeline: "Analyzing recovery incident timeline",
